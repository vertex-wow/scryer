...
| ↳   | [Progressive startupContent tier execution](backlog.md#progressive-tier-execution-for-scryer.startupcontent)           | 📋 Pending                  | Execute each cache tier in order up to the configured one | XS     | —          |
